...
Portions of this fork's development, debugging, and documentation have been
assisted by AI tools (Claude, via Claude Code). AI-assisted changes are
reviewed and verified by the maintainer before being committed.
